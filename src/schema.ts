  ...
  models: {
    Situation: {
      ...
      properties: {
        ...
        specUrl: { type: 'string', description: 'Canonical W3C WCAG 2.2 Recommendation specification URL' },
        understandingUrl: { type: 'string', description: 'Official W3C Understanding document URL' },
      },
    },
    SuccessCriterion: {
      type: 'object',
      properties: {
        ...
        specUrl: { type: 'string', description: 'Canonical W3C WCAG 2.2 Recommendation specification URL' },
        understandingUrl: { type: 'string', description: 'Official W3C Understanding document URL' },
        quickrefUrl: { type: 'string', description: 'Official W3C Quick Reference URL' },
      },
    },
    Guideline: {
      type: 'object',
      properties: {
        id: { type: 'string', description: 'Guideline slug ID (e.g. text-alternatives)' },
        num: { type: 'string', description: 'Guideline dotted number (e.g. 1.1)' },
        handle: { type: 'string', description: 'Human-readable guideline title' },
        title: { type: 'string', description: 'Guideline requirement full text' },
        specUrl: { type: 'string', description: 'Canonical W3C WCAG 2.2 Recommendation specification URL' },
        understandingUrl: { type: 'string', description: 'Official W3C Quick Reference / Understanding URL' },
        quickrefUrl: { type: 'string', description: 'Official W3C Quick Reference URL' },
      },
    },
    Principle: {
      type: 'object',
      properties: {
        id: { type: 'string', description: 'Principle slug ID (e.g. perceivable)' },
        num: { type: 'string', description: 'Principle number (e.g. 1)' },
        handle: { type: 'string', description: 'Human-readable principle name' },
        title: { type: 'string', description: 'Principle full text' },
        specUrl: { type: 'string', description: 'Canonical W3C WCAG 2.2 Recommendation specification URL' },
        understandingUrl: { type: 'string', description: 'Official W3C Quick Reference URL' },
        quickrefUrl: { type: 'string', description: 'Official W3C Quick Reference URL' },
      },
    },
    FlatTechnique: {
      ...
      properties: {
        ...
        specUrl: { type: 'string', description: 'Official W3C Technique URL' },
      },
    },
  },
};
